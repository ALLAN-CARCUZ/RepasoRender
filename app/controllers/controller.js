...
exports.create = (req, res) => {
    ...
    try {
      // Construir objeto automovil desde el cuerpo de la solicitud
      automovil.marca = req.body.marca;
      automovil.modelo = req.body.modelo;
      automovil.año = req.body.año;
      automovil.color = req.body.color;
      automovil.precio = req.body.precio;
  
      // Guardar en la base de datos MySQL
      Automovil.create(automovil).then(result => {
        // Enviar mensaje de éxito al cliente
        res.status(200).json({
          message: "Automóvil creado exitosamente con id = " + result.id,
          automovil: result,
        });
      });
    } catch (error) {
